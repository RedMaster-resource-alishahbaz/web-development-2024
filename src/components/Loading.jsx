    ...
    return (
        <div className="w-screen h-full flex items-center justify-center">
            <svg role="img"
                 ...
                 className="w-40 h-40" viewBox="0 0 128 128" width="128px" height="128px">
                <defs>
                ...
                <g stroke-linecap="round" stroke-width="12" stroke-dasharray="175.93 351.86">
                    <g>
                        <rect fill="rgb(250,0,0)" width="128" height="64" clip-path="url(#smiley-eyes)"/>
                        <g fill="none" stroke="rgb(250,0,0)">
