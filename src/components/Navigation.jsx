    ...
    return (
        <Link
            ...
            className={clsx(
                ...
                active
                    ? 'text-zinc-900 dark:text-white font-semibold text-md '
...
function VisibleSectionHighlight({group, pathname}) {
    ...
    return (
        <motion.div
            ...
            exit={{opacity: 0}}
            className="absolute inset-x-0 top-0 left-2 bg-zinc-900/5 will-change-transform dark:bg-white/2.5"
...
function ActivePageMarker({group, pathname}) {
    ...
    return (
        <motion.div
            layout
            className="absolute left-2 h-6 w-1 rounded-full bg-red-500"
            initial={{opacity: 0}}
            animate={{opacity: 1, transition: {delay: 0.2}}}
            exit={{opacity: 0}}
            style={{top}}
...
export function Navigation(props) {
    return (
        <nav {...props}>
            <ul role="list">
                <div className="xl:hidden flex items-center gap-4 my-4 w-full  justify-evenly">
